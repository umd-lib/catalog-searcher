pipeline {
  ...
  stages {
    ...
    stage('static-analysis') {
      steps {
        // Run the linter (ruff) and send output to stdout for "Record compiler warnings and
        // static analysis results" post-build action. Use `--exit-zero` to return a successs
